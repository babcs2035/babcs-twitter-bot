...
def contest():
    ...
    contestsListTitleImg = Image.open(
        "AtCoder/data/contestsListImg (title).jpg")
    contestsListImg = Image.new(
        "RGB", (1852, 68 + 64 * (len(contestsList) + sponseredContestsCnt)))
    ...
    for contest in contestsList:
        ...
        contestListDraw.text(
            (10, 7 + 32 * contest[4]), str(contest[0]), fill=(0, 0, 0), font=listFontR)
        ...
        contestListDraw.text(
            (360, 7 + 7 * contest[4]), str(contest[1]), fill=specialFontColor, font=listFontB)
        contestListDraw.text(
            (1460, 7 + 32 * contest[4]), str(contest[2]), fill=(0, 0, 0), font=listFontR)
        contestListDraw.text(
            (1660, 7 + 32 * contest[4]), str(contest[3]), fill=specialFontColor, font=listFontB)
