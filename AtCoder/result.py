...
def result():
    ...
    for atcoderID, twitterID in AtCoderIDs:
        ...
        try:
            ...
            continue
        print("cper_bot-AtCoder-result: Downloaded " + atcoderID + "'s profileData")
        ...
        if atcoderID in ratings:
            for border in range(7, 0, -1):
                if ratings[str(atcoderID)] < border * 400 and border * 400 <= nowRating:
                    ...
                    print("cper_bot-AtCoder-result: Tweeted " + atcoderID + " ( @" + twitterID + " )'s rating change")
                    break
    ...
    for contest in newcontests:
        ...
        for atcoderID, twitterID in AtCoderIDs:
            ...
            try:
                ...
                continue
            print("cper_bot-AtCoder-result: Downloaded " + atcoderID + "'s reslistData")
        ...
        if len(rankList) > 0:
            ...
            api.update_status_with_media(filename = "AtCoder/data/result/rankRankingImg_fixed.jpg", status = tweetText + "\n" + timeStamp)
        ...
        if len(perfList) > 0:
            ...
            api.update_status_with_media(filename = "AtCoder/data/result/perfRankingImg_fixed.jpg", status = tweetText + "\n" + timeStamp)
        ...
        if len(diffList) > 0:
            ...
            api.update_status_with_media(filename = "AtCoder/data/result/diffRankingImg_fixed.jpg", status = tweetText + "\n" + timeStamp)
